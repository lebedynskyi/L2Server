...
class ItemsSQL {
    companion object {
        ...
        const val INSERT_OR_UPDATE_SQL = "" +
        ...
        const val SELECT_VISIBLE_ITEMS_FOR_PLAYER_SQL = "" +
                "SELECT owner_id, object_id, item_id, enchant_level, item_location, item_location_data " +
                "FROM `items` " +
                "WHERE owner_id=? AND item_location=?"
